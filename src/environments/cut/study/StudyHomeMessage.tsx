...
const StudyHomeMessage = () => {
    ...
    return (isCut && (
        <Alert color='info' className={styles.mb1}>
            <Typography>Bienvenue sur COUNT le premier calculateur d'impact écologique dédié aux salles de cinéma.
                ...
                Opération soutenue par l'État dans le cadre du dispositif « Soutenir les alternatives vertes 2 » de France 2030, opéré par la Banque des territoires (Caisse des Dépôts) (avec logo France 2030 : bit.ly/France2030_KitCommunication)
                CUT bénéficie du soutien du CNC + logo CNC</Typography>
            <List dense>
