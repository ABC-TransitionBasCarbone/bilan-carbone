...
const POST_TO_RULENAME: Record<TiltPost, TiltRuleName> = {
  [TiltPost.ConstructionDesLocaux]: 'fonctionnement . bâtiment',
  [TiltPost.Energies]: 'fonctionnement . énergie',
  [TiltPost.DechetsDirects]: 'déchets',
  [TiltPost.FroidEtClim]: 'fonctionnement . énergie . est équipé climatisation',
  [TiltPost.AutresEmissions]: 'fonctionnement',
  [TiltPost.DeplacementsDePersonne]: 'fonctionnement . déplacements pro',
  [TiltPost.TransportDeMarchandises]: 'confiseries et boissons . fret',
  [TiltPost.IntrantsBiensEtMatieresTilt]: 'confiseries et boissons . achats',
  [TiltPost.Alimentation]: 'confiseries et boissons',
  [TiltPost.IntrantsServices]: 'fonctionnement . activités de bureau . services',
  [TiltPost.EquipementsEtImmobilisations]: 'salles et cabines . matériel technique',
  [TiltPost.Utilisation]: 'déchets',
  [TiltPost.FinDeVie]: 'déchets',
  [TiltPost.Teletravail]: 'fonctionnement',
} as const
