describe('Edit emission factor', () => {
  /**
   * TODO: Revoir les Facteurs d’émission dans le mock
   */
  // before(() => {
  ...
  //   cy.get('#edit-emission-factor-modale-title').should('be.visible')
  ...
  //   cy.getByTestId('emission-factor-search-input').within(() => {
  //     cy.get('input').type('FE Test 1')
  //   })

  //   cy.getByTestId('cell-emission-name').first().should('have.text', 'FE Test 1')
  //   cy.getByTestId('cell-emission-Valeur').first().should('have.text', '111 kgCO₂e/Go')
  // })
  ...
  //   cy.get('#delete-emission-factor-modale-title').should('be.visible')
