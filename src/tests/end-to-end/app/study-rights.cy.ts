...
describe('Study Rights', () => {
  ...
  it('should set user and manage role according to given rights', () => {
    ...
    cy.getByTestId('new-study-right-modal-accept').click()
    cy.wait('@create')
    cy.getByTestId('study-rights-table-line').eq(1).contains('bc-collaborator-2@yopmail.comLecteur')
    ...
    cy.getByTestId('new-study-right-modal-accept').click()
    cy.wait('@create')
    cy.getByTestId('study-rights-table-line').eq(1).contains('bc-collaborator-0@yopmail.comÉditeur')
    cy.getByTestId('study-rights-change-button').click()
    ...
    cy.getByTestId('new-study-right-modal-accept').click()
    cy.wait('@create')
    cy.getByTestId('study-rights-table-line').eq(0).contains('bc-admin-0@yopmail.comÉditeur')
    ...
    cy.getByTestId('study-rights-table-line').eq(1).contains('bc-admin-1@yopmail.comValidateur')
    cy.getByTestId('study-rights-table-line')
      .eq(1)
      .within(() => {
        cy.get('input').should('be.disabled')
    ...
    cy.getByTestId('study-rights-table-line').eq(4).contains('bc-collaborator-2@yopmail.comLecteur')
    cy.getByTestId('study-rights-table-line')
      .eq(4)
