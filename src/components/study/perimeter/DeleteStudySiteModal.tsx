...
const DeleteStudySiteModal = ({ open, confirmDeletion, cancelDeletion, deleting }: Props) => {
    ...
    <Modal
      ...
      actions={[
        { actionType: 'button', onClick: cancelDeletion, children: t('decline') },
        {
          ...
          children: t('accept'),
          ['data-testid']: 'delete-study-site-modal-accept',
        },
      ]}
    >
      {t.rich('description', {
...
export default DeleteStudySiteModal
