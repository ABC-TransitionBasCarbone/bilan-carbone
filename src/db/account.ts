...
import { Account as SessionAccount } from 'next-auth'
...
export const userSessionToDbUser = (userSession: SessionAccount) =>
  ({
...
export const getAccountFromUserOrganization = (user: SessionAccount) =>
