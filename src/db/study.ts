...
export const getAllowedStudiesByAccount = async (user: Account) => {
...
export const getAllowedStudyIdByAccount = async (account: Account) => {
  const organizationIds = (await getAccountOrganizations(account.id)).map((organization) => organization.id)
...
export const getAllowedStudiesByUserAndOrganization = async (account: Account, organizationId: string) => {
