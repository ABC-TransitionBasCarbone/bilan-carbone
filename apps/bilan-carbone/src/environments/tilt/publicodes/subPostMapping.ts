...
const SUBPOST_TO_RULENAME: Partial<Record<SubPost, TiltRuleName>> = {
  ...
  ConsommationsEnergieUtilisationProduits: 'utilisation . conso energie',
...
export const SUBPOST_TO_FORM_LAYOUTS: Partial<Record<SubPost, FormLayout<TiltRuleName>[]>> = {
  ...
  EnergieSimplified: [
    ...
    mosaic('énergie . emissions', [
      ...
      'énergie . emissions . gaz . consommation',
      'énergie . emissions . fioul . consommation',
      'énergie . emissions . bois . consommation',
      'énergie . emissions . granulés . consommation',
      'énergie . emissions . réseaux de chaleur . consommation',
      'énergie . emissions . réseaux de froid . consommation',
    ]),
    input('énergie . autoproduction électricité présente'),
    input('énergie . autoconsommation électricité . autoconsommation'),
  ],
  ...
  ConsommationsEnergieUtilisationProduits: [
    ...
    mosaic('utilisation . conso energie . emissions', [
      ...
      'utilisation . conso energie . emissions . fioul . consommation',
      'utilisation . conso energie . emissions . essence . consommation',
      'utilisation . conso energie . emissions . diesel . consommation',
    ]),
  ],
  ...
  DeplacementsDansLeCadreDUneMissionAssociativeSalaries: [
    ...
    table(
      ...
      'DeplacementsDansLeCadreDUneMissionAssociativeSalaries.description',
    ),
  ],
