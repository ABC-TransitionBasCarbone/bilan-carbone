...
const staticDestPath = path.join(__dirname, '.next/standalone/apps/mip/.next/static')

const publicSrcPath = path.join(__dirname, 'public')
const publicDestPath = path.join(__dirname, '.next/standalone/apps/mip/public')
...
const i18nDestPath = path.join(__dirname, '.next/standalone/apps/mip/src/i18n/translations')
