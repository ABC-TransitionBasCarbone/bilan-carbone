...
import {
  ...
  UpdateCampaignCommandValidation,
} from '@/services/serverFunctions/campaign.command'
  ...
  const form = useForm<UpdateCampaignCommand>({
    ...
    defaultValues: {
      campaigns: campaigns.map((campaign) => ({
        ...campaign, allowedAccounts: campaign.allowedAccounts.map(allowedAccount=> allowedAccount.accountMipId), createdBy: campaign.createdBy.id
      })),
    },
  })
