...
type RawModel = Record<string, ModelRule | { somme?: string[] }>
...
const SurveyCompletion = ({ onRestart }: Props) => {
  ...
  const actionsRule = modelRules['actions'] as { somme?: string[] } | undefined
  const actionKeys = actionsRule?.somme ?? []
