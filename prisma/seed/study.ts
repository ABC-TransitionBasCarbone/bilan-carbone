    ...
    data: [
      {
        ...
        geographicRepresentativeness: 1,
      ...
      },
      {
        ...
        caracterisation: EmissionSourceCaracterisation.FinalClient,
        value: 2.6,
        emissionFactorId: emissionFactors.find((emissionFactor) => emissionFactor.importedId === '34596')?.id,
        technicalRepresentativeness: 4,
        geographicRepresentativeness: 2,
        temporalRepresentativeness: 1,
        completeness: 5,
...
// Autre emissions direct => Div par 0 dans le excel
// Suppression de Papier/fin de vie moyenne, France continentale, Base Carbone
// Suppression de Papier Moyen, Hors utilisation et fin de vie, France continentale, Base Carbone - Fin de vie
// Des écarts sur les incertitudes : Exemple pour Acier ou fer blanc, France continentale, Base Carbone
// On a Très mauvaise sur l'excel alors que le site la compute en mauvaise. Dur d'investiguer parceque c'est des valeurs en dur dans l'excel et les calculs ne sont pas les mêmes (pas d'alpha ni d'intervalle de confiance à 95%)
// Pas d'impact sur les dechets à 41kgCO2e ???
